...
##### CODE PROFILE PAGE ######################################################################################
        ...
        if test_pass[0].find("A") != -1 and test_pass[0].find("B") != -1 and test_pass[0].find("C") != -1 and test_pass[0].find("D") != -1 and test_pass[0].find("E") != -1 :
            all_pass_flag = 1
            pass
        # print("profile")
...
##### CALCULATE PERCENT PROGRESS #############################################################################
    ...
    #   if event.key==pygame.K_KP_ENTER:a   